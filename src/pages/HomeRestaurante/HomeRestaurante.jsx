            ...
            <div className="container-home-restaurante">
                <header className="header-home-restaurante ">
                    <div className="container-header">
                        <div className="titulo-home-restaurante">
                            ...
                            <div className="button-header invisivel-mobile ">
                                <Button className="button-meus-itens" variant="primary">Meus itens</Button>
                                <Button className="button-add-itens" variant="primary">Adicionar novo item</Button>
                            </div>
                        </div>
                    ...
                    <div className="invisivel-desktop button-home-restaurante">
                        <Button className="button-header" variant="primary">Adicionar refeição</Button>
                    </div>
                </header>

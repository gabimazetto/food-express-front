...
export function EditarCliente() {
    ...
    useEffect(() =>{
      ...
      .then(response =>{
        const { nome, email, senha, telefone, cpf, dataNascimento, 
          endereco: {uf, cidade, cep, rua, numero, complemento} } = response.data;
          reset({ nome, email, senha, telefone, cpf, dataNascimento, 
